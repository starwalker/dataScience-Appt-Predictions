...
# split the data
X_train, X_test, y_train, y_test = train_test_split(features, data[target_col], test_size=.3, random_state=0)
...
file = 'models/optimal_NoShow_AppointmentLevel_CW_params.p'
pickle.dump(x.xgb_params_best, open(file, 'wb'))

# save the best model
file = 'models/NoShow_AppointmentLevel_CW.p'
